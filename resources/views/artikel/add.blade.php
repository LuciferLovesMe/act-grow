                    ...
                    <div class="card mt-3">
                        <form action="{{ route('artikel.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control" required name="tanggal" placeholder="Tanggal Artikel">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" name="judul" class="form-control" required placeholder="Judul Artikel">
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <textarea name="teks_artikel" class="form-control" id="text-artikel" cols="" rows="" placeholder="Teks Artikel"></textarea>
                                    </div>
                                </div>
                            </div>
